...
public class SlowKajDrive extends Command {

  DriveTrain dt;
	DoubleSupplier forwardPercent, turnPercent;
	DoubleSupplier leftTurn, rightTurn;
	
	public SlowKajDrive(DriveTrain dt, DoubleSupplier forwardPercent, DoubleSupplier turnPercent, DoubleSupplier leftTurn, DoubleSupplier rightTurn) {
