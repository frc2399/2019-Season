...
public class MiddleCargoRightMiddle extends CommandGroup {
  /**
   * Starts from the middle, goes to the middle right cargo slot, goes to depot, picks up ball
   */
  public MiddleCargoRightMiddle(DriveTrain dt, AHRS navx, CargoElevator ca) {
    //drives off level 1 platform
    addSequential(new DriveDistance(dt, navx, RobotMap.Autonomous.OFF_FIRST_PLATFORM));
    //drives to middle right cargo slot
