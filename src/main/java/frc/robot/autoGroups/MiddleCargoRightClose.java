...
public class MiddleCargoRightClose extends CommandGroup {
  /**
   * Starts from the middle, goes to the closest right cargo slot, goes to depot, picks up ball
   */
  public MiddleCargoRightClose(DriveTrain dt, AHRS navx, CargoElevator ca) {
    ...
    addSequential(new DriveDistance(dt, navx, 131));
